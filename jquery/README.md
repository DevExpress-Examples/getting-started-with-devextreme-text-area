# Getting Started with DevExtreme jQuery TextArea

This repository stores jQuery source code for the [Getting Started with TextArea](https://js.devexpress.com/Documentation/Guide/UI_Components/TextArea/Getting_Started_with_TextArea/) tutorial.
